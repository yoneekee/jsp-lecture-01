...
pageContext.setAttribute("boardDto", dto);
%>

<main>
	<form class="form" action="../board/updateProcess?no=${boardDto.no}"
		method="POST">
		<table class="board">
			<colgroup>
				<col style="width: 20%">
			...
			<tbody>
				<tr>
					<th>이름</th>
					<td><p>${boardDto.userName}</p></td>
				</tr>
				<tr>
					<th>제목</th>
					<td><input type="text" name="title" placeholder="${boardDto.title}"></td>
				</tr>
				<tr>
					<th>내용</th>
					<td><textarea name="contents" id="summernote" placeholder="${boardDto.contents}"></textarea></td>
				</tr>
			</tbody>
		</table>
		<div class="btns">
